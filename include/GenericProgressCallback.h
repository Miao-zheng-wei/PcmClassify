#ifndef _H_GENERICPROGRESSCALLBACK_H_
#define _H_GENERICPROGRESSCALLBACK_H_
...
public:
    ...
    //! Notifies the algorithm range
    /**\param  max progress value, and default range from 0 to 100
	**/
    virtual void setMAXRange(int maxvalue) = 0;
